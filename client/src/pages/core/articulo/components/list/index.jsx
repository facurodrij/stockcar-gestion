...
export default function ArticuloList({ permissions }) {
    ...
    const editUrl = '/articulos/form';
    const detailUrl = '/articulos';
    const allowView = checkPermissions(['articulo.view'], false);
    const allowCreate = checkPermissions(['articulo.create'], false);
    const allowUpdate = checkPermissions(['articulo.update'], false);
    const allowDelete = checkPermissions(['articulo.delete'], false);
