...
export default function ProveedorList({ permissions }) {
    const apiUrl = `${API}/proveedores`;
    const editUrl = '/proveedores/form';
    ...
    const allowCreate = checkPermissions(['proveedor.create'], false);
    const allowUpdate = checkPermissions(['proveedor.update'], false);
