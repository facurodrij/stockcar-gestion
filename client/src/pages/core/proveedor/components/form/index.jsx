...
export default function ProveedorForm({ permissions }) {
        ...
        const loadData = async () => {
            try {
                ...
                if (Boolean(pk)) {
                    ...
                    setValue('tipo_responsable_id', proveedor.tipo_responsable_id);
                    setValue('razon_social', proveedor.razon_social);
                    setValue('tipo_documento_id', proveedor.tipo_documento_id);
                    ...
                    setValue('provincia_id', proveedor.provincia_id);
                    if (proveedor.telefono) setValue('telefono', proveedor.telefono);
                    if (proveedor.email) setValue('email', proveedor.email);
                    setValue('descuento', proveedor.descuento);
                    setValue('recargo', proveedor.recargo);
    ...
    const onError = (errors) => {
        ...
        if (errors['descuento'] || errors['recargo']) {
            setTabValue(1);
        }
    }
    ...
    return (
        <>
            <PageTitle heading={Boolean(pk) ? 'Editar Proveedor' : 'Nuevo Proveedor'} />
