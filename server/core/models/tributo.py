...
class Tributo(db.Model):
    ...
    tipo_comprobantes = relationship('TipoComprobante', secondary='tributo_tipo_comprobante', backref='tributos')
    tipo_responsables = relationship('TipoResponsable', secondary='tributo_tipo_responsable', backref='tributos')
    ventas = relationship('Venta', secondary='tributo_venta', backref='tributos')
    articulos = relationship('Articulo', secondary='tributo_articulo', backref='tributos')
